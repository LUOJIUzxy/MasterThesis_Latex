...
\newcommand*{\getTitleGer}{Portfolio-Optimierung mit Gauß-Prozess Regression}
...
\begin{acronym}
	...
	\acro{JNJ}[JNJ]{Johnson \& Johnson}
	\acro{BA}[BA]{The Boeing Company}
	\acro{CAPM}[CAPM]{Capital Asset Pricing Model}
	\acro{WPE}[WPE]{Weighted Permutation Entropy}
	\acro{DE}[DE]{Dispersion Entropy}
	\acro{PE}[PE]{Permutation Entropy}
	% TODO: add acronyms
\end{acronym}
